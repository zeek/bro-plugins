...
export {
	...
	const SNF_RSS_IP        =  0x01; #<< Include IP (v4 or v6) SRC/DST addr in hash
	const SNF_RSS_SRC_PORT  =  0x10; #<< Include TCP/UDP/SCTP SRC port in hash
	const SNF_RSS_DST_PORT  =  0x20; #<< Include TCP/UDP/SCTP DST port in hash 
	const SNF_RSS_GTP       =  0x40; #<< Include GTP TEID in hash
	const SNF_RSS_GRE       =  0x80; #<< Include GRE contents in hash
