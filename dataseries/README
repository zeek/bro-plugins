...
Bro comes with experimental support for `DataSeries
<http://www.hpl.hp.com/techreports/2009/HPL-2009-323.html>`_ output,
an efficient binary format for recording structured bulk data.
DataSeries is developed and maintained at HP Labs.
...
To use the DataSeries plugin, the DataSeries libraries must be
available at compile-time, along with the supporting *Lintel* package.
Generally, both are distributed on `HP Labs' web site
...
Installing the DataSeries Plugin
--------------------------------

Once you have installed DataSeries, the following will compile and
install the plugin alongside Bro::
...
If everything built and installed correctly, you should see this::
    ...
    # bro -N Bro::DataSeries
    Bro::DataSeries - DataSeries log writer (dynamic, version 1.0)
